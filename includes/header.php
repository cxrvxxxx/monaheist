<!--
<nav class="navi navbar sticky-top navbar-expand-lg bg-dark" data-bs-theme="dark">
  <div class="d-flex px-2 mx-2">
    <a href="index.php" class="navbar-text navbar-brand h1">MonaHeist</a>
    ...
    <a href="shop.php" class="navbar-text navbar-nav mx-2">Shops</a>
    ...
    <a href="bank.php" class="navbar-text navbar-nav mx-2">Banks</a>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="images/blurred-image-1.jpg">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="devmod.php">
              <p>Devs & Mods</p>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="shoplisting.php">
              <p>Listings</p>
            </a>
          </li>
          <li class="nav-item">
