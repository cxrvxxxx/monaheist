            ...
            <div class="content-center">
                <div class="container">
                    ...
                    <div class="text-center">
                        <a href="https://github.com/cxrvxxxx/monaheist" class="btn btn-primary btn-icon btn-round" target="__blank">
                            <i class="fab fa-github"></i>
                        </a>
                        <a href="https://www.facebook.com/CITUniversity" class="btn btn-primary btn-icon btn-round" target="__blank">
                            <i class="fab fa-facebook-square"></i>
                        </a>
                        <a href="https://youtu.be/dQw4w9WgXcQ" class="btn btn-primary btn-icon btn-round" target="__blank">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
                        ...
                        <a href="login.php" class="btn btn-info btn-round" target="__blank">Log-in</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="images/daniel2.png" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised" width="200" height="200">
                        ...
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="images/dawn.jpg" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised" width="200" height="200">
                        ...
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="images/brent.jpg" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised" width="200" height="200">
                        ...
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="images/ced.jpg" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised" width="200" height="200">
                        ...
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="images/michael.jpg" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised" width="200" height="200">
